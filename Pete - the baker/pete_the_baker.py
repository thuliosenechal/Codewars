...
200). Ingredients that are not present in the objects, can be considered 
as 0.
...
def cakes(recipe, available):
    ...
    qtd_recipe = [available[key] // recipe[key] for key in recipe]
    
    return min(qtd_recipe)
...
if __name__ == '__main__':
    ...
    r2 = {'flour': 500, 'sugar': 200, 'eggs': 1}
    a2 = {'sugar': 1200, 'flour': 1200, 'eggs': 5, 'milk': 200}
    print(cakes(r2, a2))
